...
const features = [
  {
    name: 'Learn with one account',
    description:
      'Sign in to your account to access all of features and track your progress.',
    icon: DeviceArrowIcon,
  },
  {
    name: 'Match with criteria',
    description:
      'Choose the question difficulty and/or type, and we will find someone to practice with you.',
    icon: DeviceCardsIcon,
  },
  {
    name: 'Realistic and comprehensive question bank',
    description:
      'Get genuine questions from real interviews and practice with them.',
    icon: DeviceClockIcon,
  },
  {
    name: 'Track your learning history',
    description:
      'Mark questions as completed and revisit them to view your past solutions',
    icon: DeviceListIcon,
  },
  {
    name: 'Collabrative real time editor',
    description:
      'Work with your friend on the same question and see their changes in real time.',
    icon: DeviceLockIcon,
  },
  {
    name: 'Video and audio chat',
    description:
      'Want a more personal touch? Video and audio chat with your friend.',
...
export function SecondaryFeatures({ username }) {
  return (
    <section
