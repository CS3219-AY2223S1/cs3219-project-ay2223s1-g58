...
// USER SERVICE API
const URI_USER_SERVICE = process.env.NODE_ENV === 'production' ? 'http://localhost:80' : 'http://localhost:8000'
...
const URI_QUESTION_SERVICE = process.env.NODE_ENV === 'production' ? 'http://localhost:80' : 'http://localhost:8500'
...
export const URI_MATCHING_SERVICE = process.env.NODE_ENV === 'production' ? 'http://localhost:80' : 'http://localhost:8001'
